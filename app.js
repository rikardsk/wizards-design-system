...
const TILE_MANIFEST = [
    ...
    { id: "Ancient Temple Ruins", label: "Ancient Ruins", file: "Ancient Temple Ruins.png" },
    { id: "Battle Arena", label: "Battle Arena", file: "Battle Arena.png" },
    { id: "Cave Network", label: "Cave Network", file: "Cave Network.png" },
    { id: "City of the dead", label: "City of the Dead", file: "City of the dead.png" },
    { id: "Coastal Fort", label: "Coastal Fort", file: "Coastal Fort.png" },
    { id: "Crypt of the undead", label: "Crypt of the Undead", file: "Crypt of the undead.png" },
    { id: "Dragons Nest", label: "Dragon's Nest", file: "Dragons Nest.png" },
    { id: "Dragons Peak", label: "Dragon's Peak", file: "Dragons Peak.png" },
    { id: "Forest", label: "Forest", file: "Forest.png" },
    { id: "Gladiator School", label: "Gladiator School", file: "Gladiator School.png" },
    { id: "Goblin Camp", label: "Goblin Camp", file: "Goblin Camp.png" },
